...
- *YTD총계 (Year To Date) 설정하여 년 기준 누계 표시*  
1. '행'에 (주문날짜/년), (주문날짜/월) 드랍 - (매출) 더블클릭 후 우클릭 **'퀵 테이블 계산-YTD총계'**  
2. 새 (매출) 더블클릭하여 시트에서 확인  
<img width="450" alt="image" src="https://github.com/Choe-minsung/TIL/assets/145301343/87d757ab-38d3-4311-8c9f-67a098a9f23e">  
